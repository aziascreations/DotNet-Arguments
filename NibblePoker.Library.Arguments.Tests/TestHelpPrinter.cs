...
namespace NibblePoker.Library.Arguments.Tests {
    ...
    public class TestHelpPrinter {
        ...
        public void Setup() {
            ...
            _defaultRequiredOption = new Option('i', null, "Default option 2",
        ...
        public void TestDetailsPartGetter() {
            ...
            Assert.Multiple(() => {
                ...
                Assert.That(HelpText.GetOptionDetailsPart(_mixedValueOption, 0, true),
                    Is.EqualTo("-e <ECHO>, --echo <ECHO>"));
                Assert.That(HelpText.GetOptionDetailsPart(_defaultOption, 0, true),
                    Is.EqualTo("-h <HOTEL>, --hotel <HOTEL>"));
