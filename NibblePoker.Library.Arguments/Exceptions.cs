...
public static class Exceptions {
	...
	/// <summary>
	/// Common parent exception extended by all exceptions thrown by
	...
	///  instantiated with a `token` or a `name`.
	/// </summary>
	...
	///  whose name is `null` or empty, is passed to
	...
	///  if it is given a '--' token twice, or after reaching the end of options.
	/// </summary>
